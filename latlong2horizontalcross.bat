@ECHO OFF
@title latlong2horizontalcross v1.6 - immersive transformations

echo latlong2horizontalcross v1.6 - 2016-08-18
echo script by Andrew Hazelden
echo ----------------------------------------------------------------------
echo latlong2horizontalcross converts a latlong formatted image sequence
echo into a cubic horizontal cross format using the moving panorama program by 
...
REM Output image - final stitched horizontal cross
@set output_cube_horizontal=%outputFolder%\horizontalcross
...
PAUSE
REM C:\dome2rect\review.bat %output_cube_horizontal%.%%d.%output_ext%
