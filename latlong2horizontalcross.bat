@ECHO OFF
@title latlong2horizontalcross v1.5 - immersive transformations

echo latlong2horizontalcross v1.5 - 2016-03-28
...
@set output_cube_horizontal=output\horizontalcross
