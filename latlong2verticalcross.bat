@ECHO OFF
@title latlong2verticalcross v1.3 - immersive transformations

echo latlong2verticalcross v1.3 - May 6, 2015
...
REM Vertical Cross Merging Start/End Sequence Frame Range:
