...
void sphere_mirror( double x_dest,double  y_dest, double* x_src, double* y_src, void* params);
void mirror_sphere( double x_dest,double  y_dest, double* x_src, double* y_src, void* params);
